...
export default function Slide05Dataset() {
  return (
    <NordSlide>
      <Title stagger={0}>数据集: Narratives “21st Year”</Title>
      ...
      >
        ...
        <Card style={{ padding: 0, overflow: 'hidden', borderColor: 'rgba(255,255,255,0.10)', background: 'rgba(0,0,0,0.22)' }}>
          <div style={{ padding: 18, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ height: 140, marginTop: 10, borderRadius: 14, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden' }}>
              <Waveform color={COLORS.accent1} live opacity={0.9} />
            </div>
          </div>

          <div style={{ padding: 18 }}>
            <div style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontStyle: 'italic', color: 'rgba(235,203,139,0.95)', lineHeight: 1.45 }}>
