  ...
  return (
    <NordSlide>
      ...
      <div data-stagger="" style={{ '--stagger-delay': '400ms' }}>
        ...
        >
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(163,190,140,0.18), rgba(0,0,0,0.00))' }} />
          ...
          <div
            style={{
              ...
              width: 160,
              height: 86,
              background: 'rgba(163,190,140,0.58)',
              borderRadius: 999,
              filter: 'blur(18px)',
              boxShadow: '0 0 70px rgba(163,190,140,0.55)',
            }}
          />
          ...
          >
            <Text>
              ...
              <br />
              处理高度局域化。全脑大部分区域为暗色，唯独双侧颞上回 (<span className="kw kwG">STG/A1</span>) 附近呈现更亮的激活光斑。
            </Text>
          </div>
        </div>
      </div>
