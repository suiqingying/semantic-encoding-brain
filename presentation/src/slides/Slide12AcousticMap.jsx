...
export default function Slide12AcousticMap() {
    ...
    async function load() {
      try {
        ...
        const [colorsResp, statsResp] = await Promise.all([
          fetch(`${import.meta.env.BASE_URL}assets/corr_layer9_roi_colors_lh.json`),
          fetch(`${import.meta.env.BASE_URL}assets/corr_layer9_roi_stats_lh.json`),
        ])
