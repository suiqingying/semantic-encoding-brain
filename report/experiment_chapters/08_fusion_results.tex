...
空间分布方面，图 \ref{fig:fusion_montage} 展示融合 Top 配置的脑图对照，图 \ref{fig:fusion_best_map} 展示全局最优融合配置的单独脑图，从而把融合结果纳入与单模态一致的“统计图—ROI 图—脑图”证据链。需要强调的是，融合最优均值相关（约 0.053）仍明显低于音频与多模态在 6TR 条件下的 0.08--0.09 量级强基线，因此在当前结果覆盖范围内，特征拼接融合并未带来超越强音频模型的整体优势。我们很难说明这一现象是“文本无用”还是“融合覆盖不足”。我认为文本性能过低很可能极大的限制了融合潜力，而当前融合仅覆盖到 3TR，未能充分利用更长时间尺度下音频模型的优势。后续需要在更长 TR 窗口下补齐融合覆盖，并探索更合理的跨模态融合策略，才能更有把握地回答“文本与音频特征是否互补”这一核心问题。
