...
\setCJKsansfont{SimSun}[BoldFont=SimHei]
\setCJKmonofont{SimSun}
\newCJKfontfamily{\TitleCJK}{SimHei}
...
\usepackage{titlesec}
\titleformat{\section}
  {\TitleCJK\sffamily\huge\color{BrandColor}}
...
\titleformat{\subsection}
  {\TitleCJK\sffamily\Large\color{DarkText}}
  {}
  {0em}
...
\titleformat{\subsubsection}
  {\TitleCJK\sffamily\large\color{BrandColor}}
  {\thesubsubsection}
  {1em}
  {}
...
% ===================== 6. 目录重构 =====================
\usepackage{titletoc}
\renewcommand{\contentsname}{\TitleCJK\Huge 目录}
